					...
					columns : [{
							...
							},
							{
								...
								mRender:function(data,type,row){
									...
									else{str+='<input type="checkbox" value="'+row.id+'"/>';}
							...
							initComplete:function(){
								...
								api.$('.switch input[type="checkbox"]').on('change',function(){
									...
									var dMsg = (checked)?'You want to activate the product?':'You want to deactive the product?';
