...
public class UserDAOImpl implements UserDAO {
	...
	public Address getBillingAddress(User user) {
		...
		try{
			...
			return sessionFactory.getCurrentSession().createQuery(selectQry,Address.class).setParameter("user", user).setParameter("billing", true).getSingleResult();
	...
	public List<Address> listShippingAddress(User user) {
		...
		try{
			...
			return sessionFactory.getCurrentSession().createQuery(selectQry,Address.class).setParameter("user", user).setParameter("shipping", true).getResultList();
